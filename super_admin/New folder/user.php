        ...
        <form method="post">
            <div class="form-row">
                <div class="form-group">
                    <label for="branch_Name">First Name</label>
                    <input type="text" id="branch_Name" name="branch_Name" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="branch_Address">Last Name</label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="branch_Phone_Number" name="branch_Phone_Number" class="form-control" required>
                </div>
                <div class="form-group">
