...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">ABC Restaurant</div>
  </div>
</div>
...
echo '<form method="post" action="shopping_Cart.php?action=add&code='.$row['id'].'">';
   ...
   /* echo '<div class="w3-quarter">';
    echo   '<img src="/w3images/steak.jpg" alt="Steak" style="width:100%">';
    echo    '<h3>Let Me Tell You About This Steak</h3>';
    echo   ' <p>Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>';
    echo   '</div>';
    
    echo   '  <div class="w3-quarter">';
    echo      '<img src="/w3images/cherries.jpg" alt="Cherries" style="width:100%">';
    echo     '<h3>Cherries, interrupted</h3>';
    echo '    <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>';
    echo  '     <p>What else?</p>';
    echo '  </div>';
    
    echo  ' <div class="w3-quarter">';
    echo   '  <img src="/w3images/wine.jpg" alt="Pasta and Wine" style="width:100%">';
    echo     ' <h3>Once Again, Robust Wine and Vegetable Pasta</h3>';
    echo   '  <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>';
    echo  ' </div>';
    */
